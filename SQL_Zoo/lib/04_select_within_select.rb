...
def neighbors_of_certain_b_countries
  ...
  execute(<<-SQL)
    ...
    FROM
      countries AS world
      JOIN countries AS b_countries
      ON world.continent = b_countries.continent
        WHERE
          b_countries.name = 'Belize' OR  b_countries.name = 'Belgium'
...
# -- JOIN countries AS pop
# -- ON sparse.continents = (
# --   SELECT
# --     continents
# --   FROM
# --     sparse
